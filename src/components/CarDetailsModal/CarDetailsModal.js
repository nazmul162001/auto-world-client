            ...
            <div className='p-3 leading-10'>
              <div>
                <h3 className='font-bold'>
                  Posted: <span className='text-gray mx-3'>{createdDay}</span>
                  {createdTime}
                </h3>
                <h3 className='font-bold'>
                  Car Name <span className='text-gray ml-3'>{carName}</span>
                </h3>
                <h3 className='font-bold'>
                  Mileage: <span className='text-gray ml-3'>{mileage}</span>
                </h3>
                <h3 className='font-bold'>
                ...
                <h3 className='font-bold'>
                  Transmission: <span className='text-gray ml-3'>{transmission}</span>
                </h3>
                <h3 className='font-bold'>
                  Price: $<span className='text-gray ml-3'>{price}</span>
                </h3>
              </div>
              <Button className='my-5 bg-secondary text-primary font-bold text-lg capitalize flex justify-center items-center' fullWidth>Make Purchase <FaLocationArrow className='ml-2' /> </Button>
            </div>
          </DialogBody>
        </Dialog>
      </Fragment>
